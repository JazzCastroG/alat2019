(function($){
  ...
  //Home Page map
        ...
        var mapOptions = {
            center: new google.maps.LatLng(8.9896587, -79.5000509),
            zoom: 17,
            styles: styleArray,
            scrollwheel: false,
        ...
        var map = new google.maps.Map(document.getElementById("home-map"),
            mapOptions);
        var myLatlng = new google.maps.LatLng(8.9896587, -79.5000509);
